...
const { validateName, validateProduct, validateQuantity } = require('./middlewares/validation');
...
app.post('/sales', validateProduct, validateQuantity, salesController.insertSales);
